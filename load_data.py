...
def trim_pairs(input_lang, output_lang, pairs):
    keep_pairs = []
...
def random_batch(input_lang, output_lang, pairs, batch_size, USE_CUDA=True):
    input_seqs = []
    target_seqs = []
    ...
    # For input and target sequences, get array lengths and pad with 0s to max length
